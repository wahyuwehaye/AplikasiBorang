    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ol class="breadcrumb breadcrumb-col-deep-purple align-right">
                ...
                <li class="active"><i class="material-icons">file_upload</i> Dokumen Butir</li>
            </ol>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                ?>
                    <div class="row clearfix">
                        ...
                        <input type="hidden" name="halaman" id="halaman"value="<?php echo $this->uri->segment(2, 0);?>">
                        <div class="col-sm-12">
...
<script>
  ...
  function dele(x){
    var hal = $this->uri->segment(2, 0);
    var borang = "<?php echo $buku[0]['id']?>";
    var delete_url = "<?php echo base_url(); ?>index.php/C_butir/destroy/"+x+"/"+borang+"/"+hal;
        swal({
            title: "Are you sure?",
            text: "You will not be able to recover this imaginary file!",
            type: "warning",
