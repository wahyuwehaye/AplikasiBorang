...
('3.1.4', 'Tuliskan data jumlah mahasiswa reguler tujuh tahun terakhir ', '', '', NOW(), NOW(), ".$id."),
...
('5.1.1.a', 'Struktur kurikulum (harus memuat standar kompetensi lulusan yang terstruktur dalam kompetensi utama, pendukung dan lainnya ).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.1.b', 'Orientasi dan kesesuaian kurikulum dengan visi dan misi PS.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.2.a', 'Kesesuaian mata kuliah dengan standar kompetensi.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.2.b', 'Persentase mata kuliah  yang dalam penentuan nilai akhirnya memberikan bobot pada tugas-tugas (PR atau makalah) ≥ 20%. ', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.2.c', 'Matakuliah dilengkapi dengan deskripsi matakuliah, silabus dan SAP.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.3', 'Fleksibilitas mata kuliah pilihan.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.1.4', 'Substansi praktikum dan pelaksanaan praktikum.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.2.a', 'Pelaksanaan peninjauan kurikulum selama 5 tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.2.b', 'Penyesuaian kurikulum dengan perkembangan Ipteks dan kebutuhan.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.3.1.a', 'Pelaksanaan pembelajaran memiliki mekanisme untuk memonitor, mengkaji, dan memperbaiki secara periodik kegiatan perkuliahan (kehadiran dosen dan mahasiswa), penyusunan materi perkuliahan, serta penilaian hasil belajar.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.3.1.b', 'Mekanisme penyusunan materi perkuliahan.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.3.2', 'Mutu soal ujian.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.4.1.a', 'Rata-rata banyaknya mahasiswa per dosen Pembimbing Akademik per semester.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.4.1.b', 'Pelaksanaan kegiatan pembimbingan akademik.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.4.1.c', 'Jumlah rata-rata pertemuan pembimbingan akademik per mahasiswa per semester.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.4.2', 'Efektivitas kegiatan pembimbingan akademik.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.5.1.a', 'Ketersediaan panduan, sosialisasi,  dan penggunaan.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.5.1.b', 'Rata-rata mahasiswa per dosen pembimbing tugas akhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.5.1.c', 'Rata-rata jumlah pertemuan/ pembimbingan selama penyelesaian TA.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.5.1.d', 'Kualifikasi akademik dosen pembimbing tugas akhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.5.2', 'Rata-rata waktu penyelesaian penulisan tugas akhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.6', 'Upaya perbaikan sistem pembelajaran yang telah dilakukan selama tiga tahun terakhir. ', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.7.1', 'Kebijakan tentang suasana akademik (otonomi keilmuan, kebebasan akademik, kebebasan mimbar akademik).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.7.2', 'Ketersediaan dan jenis prasarana, sarana dan dana yang memungkinkan terciptanya interaksi akademik antara sivitas akademika.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.7.3', 'Program dan kegiatan akademik untuk menciptakan suasana akademik (seminar, simposium, lokakarya, bedah buku, penelitian bersama dll).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.7.4', 'Interaksi akademik antara dosen-mahasiswa.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('5.7.5', 'Pengembangan perilaku kecendekiawanan.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.1', 'Keterlibatan program studi dalam perencanaan target kinerja, perencanaan kegiatan/ kerja dan perencanaan/alokasi dan pengelolaan dana. ', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.2.1', 'Besarnya dana (termasuk hibah) yang dikelola dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.2.2', 'Dana penelitian dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.2.3', 'Dana yang diperoleh dalam rangka pengabdian kepada masyarakat dalam tiga  tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.3.1', 'Luas ruang kerja dosen', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.3.2', 'Prasarana (kantor, ruang kelas, ruang laboratorium, studio, ruang perpustakaan, kebun percobaan, dsb. kecuali  ruang dosen) yang dipergunakan PS dalam proses pembelajaran.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.3.3', 'Prasarana lain yang menunjang (misalnya tempat olah raga, ruang bersama, ruang himpunan mahasiswa, poliklinik).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.1.a', 'Bahan pustaka yang berupa buku teks.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.1.b', 'Bahan pustaka yang berupa disertasi/tesis/ skripsi/ tugas akhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.1.c', 'Bahan pustaka yang berupa jurnal ilmiah terakreditasi Dikti.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.1.d', 'Bahan pustaka yang berupa jurnal ilmiah internasional .', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.1.e', 'Bahan pustaka yang berupa prosiding seminar dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.2', 'Akses ke perpustakaan di luar PT atau sumber pustaka lainnya.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.4.3', 'Ketersediaan, akses dan pendayagunaan sarana utama di lab (tempat praktikum, bengkel, studio, ruang simulasi, rumah sakit, puskesmas/balai kesehatan, green house, lahan untuk pertanian, dan sejenisnya).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.5.1', 'Sistem informasi dan fasilitas yang digunakan PS dalam proses pembelajaran (hardware, software, e-learning, dan perpustakaan).', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('6.5.2', 'Aksesibilitas data dalam sistem informasi.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.1.1', 'Jumlah penelitian yang dilakukan oleh dosen tetap yang bidang keahliannya sesuai dengan PS per tahun, selama 3 tahun.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.1.2', 'Keterlibatan mahasiswa yang melakukan tugas akhir dalam penelitian dosen.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.1.3', 'Jumlah artikel ilmiah yang dihasilkan oleh dosen tetap yang bidang keahliannya sesuai dengan PS per tahun, selama tiga tahun.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.1.4', 'Karya-karya PS/institusi yang telah memperoleh perlindungan Hak atas Kekayaan Intelektual (HaKI) dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.2.1', 'Jumlah kegiatan Pengabdian kepada Masyarakat (PkM) yang dilakukan oleh dosen tetap yang bidang keahliannya sesuai dengan PS.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.2.2', 'Keterlibatan mahasiswa dalam kegiatan pengabdian kepada masyarakat.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.3.1', 'Kegiatan kerjasama dengan instansi di dalam negeri dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id."),
('7.3.2', 'Kegiatan kerjasama dengan instansi di luar negeri dalam tiga tahun terakhir.', 'namadokumen', '', '', NOW(), NOW(), ".$id.")");
