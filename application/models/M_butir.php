...
('3.1.4.a', 'Persentase kelulusan tepat waktu (KTW)', '', 'Nilai 4 - Jika KTW ≥ 50%, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.4.b', 'Persentase mahasiswa yang DO atau mengundurkan diri (MDO).', '', 'Nilai 4 - Jika MDO ≤  6%, maka skor = 4.', NOW(), NOW(), ".$id."),
...
('7.3.2', 'Kegiatan kerjasama dengan instansi di luar negeri dalam tiga tahun terakhir.', '', '', '', NOW(), NOW(), ".$id.")");
        ...
        public function buatbutir3BS1($id){
            $this->db->query("INSERT INTO `butir` (`butir`, `bakumutu`, `penjelasan`, `keterangan`, `created_at`, `updated_at`, `id_borang`) VALUES
('1.1.1', 'Kejelasan dan kerealistikan visi, misi, tujuan, dan sasaran Fakultas/Sekolah Tinggi.', '', 'Nilai 4 - Memiliki visi, misi, tujuan, dan sasaran yang sangat jelas dan sangat realistik.\r\n', NOW(), NOW(), ".$id."),
('1.1.2', 'Strategi pencapaian sasaran dengan rentang waktu yang jelas dan didukung oleh dokumen.', '', 'Nilai 4 - Strategi pencapaian sasaran:\r\n(1)  dengan tahapan waktu yang jelas dan sangat realistik\r\n(2) didukung dokumen yang sangat lengkap. \r\n', NOW(), NOW(), ".$id."),
('1.2', 'Sosialisasi yang efektif tercermin dari tingkat pemahaman pihak terkait.', '', 'Nilai 4 - Dipahami dengan baik oleh seluruh sivitas akademika  dan tenaga kependidikan. ', NOW(), NOW(), ".$id."),
('2.1', 'Tata pamong menjamin terwujudnya visi, terlaksananya misi, tercapainya tujuan, berhasilnya strategi yang digunakan secara kredibel, transparan, akuntabel, bertanggung jawab, dan adil', '', 'Nilai 4 - Adanya dokumen, data dan informasi yang sahih dan andal bahwa seluruh unsur tata pamong menjamin penyelenggaraan perguruan tinggi yang memenuhi 5 aspek berikut: \r\n(1)   kredibel\r\n(2) transparan\r\n(3)   akuntabel\r\n(4)    bertanggung jawab\r\n(5)    adil', NOW(), NOW(), ".$id."),
('2.2', 'Efisiensi dalam struktur organisasi.', '', 'Nilai 4 - Struktur organisasi mampu menggerakkan fungsi lembaga secara sangat efisien.', NOW(), NOW(), ".$id."),
('2.3', 'Karakteristik kepemimpinan yang efektif.', '', 'Nilai 4 - Kepemimpinan Fakultas/Sekolah Tinggi kuat dalam semua memiliki karakteristik yang kuat dalam: \r\n(1) kepemimpinan operasional, \r\n(2) kepemimpinan organisasi, \r\n(3) kepemimpinan publik \r\n', NOW(), NOW(), ".$id."),
('2.4', 'Sistem pengelolaan fungsional dan operasional Fakultas/Sekolah Tinggi mencakup: planning, organizing, staffing, leading, controlling yang efektif dilaksanakan.\r\n\r\nHal-hal tsb dapat diverifikasi dalam dokumen Renstra dan Renop.', '', 'Nilai 4 - Sistem pengelolaan fungsional dan operasional Fakultas/Sekolah Tinggi berjalan sesuai dengan SOP, yang didukung dokumen yang lengkap.', NOW(), NOW(), ".$id."),
('2.5.1', 'Keberadaan dan efektivitas unit pelaksana penjaminan mutu.', '', 'Nilai 4 - Memiliki unit penjaminan mutu di tingkat pusat/fakultas yang telah sepenuhnya melakukan proses penjaminan mutu.', NOW(), NOW(), ".$id."),
('2.5.2', 'Memiliki standar mutu.', '', 'Nilai 4 - Tersedia standar mutu yang  lengkap dan dilaksanakan dengan sangat baik.', NOW(), NOW(), ".$id."),
('3.1.1', 'Tersedia sistem penerimaan  mahasiswa baru  dan dilaksanakan secara konsisten.  \r\nDokumen sistem penerimaan mahasiswa baru mencakup:\r\n(1)    kebijakan penerimaan mahasiswa baru\r\n(2)  kriteria penerimaan mahasiswa baru \r\n(3)  prosedur penerimaan mahasiswa baru\r\n(4)   instrumen; penerimaan mahasiswa baru \r\n(5)    sistem pengambilan keputusan', '', 'Nilai 4 - Tersedia dokumen lengkap tentang penerimaan mahasiswa baru dan dilaksanakan secara konsisten. ', NOW(), NOW(), ".$id."),
('3.1.2', 'Rasio mahasiswa baru transfer terhadap mahasiswa baru bukan transfer.\r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\n\r\nPerhitungan skor untuk program S1 yang dikelola Fakultas/ Sekolah Tinggi.\r\n\r\nTMBT = total mahasiswa baru transfer dalam Fakultas/Sekolah Tinggi program S1 reguler dan S1 non-reguler\r\nTMB = total mahasiswa baru bukan transfer dalam Fakultas/Sekolah Tinggi untuk program S1 reguler dan S1 non-reguler\r\nRM = rasio total mahasiswa baru transfer terhadap total mahasiswa baru keseluruhan\r\n', '', 'Nilai 4 - Jika RM ≤ 0.25, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.3', 'Motivasi penerimaan mahasiswa transfer\r\n\r\nAlasan menerima mahasiswa transfer seharusnya untuk meningkatkan layanan pendidikan.  Penerimaan mahasiswa transfer dilakukan dengan proses seleksi yang baik/ketat dalam upaya tetap menjaga mutu, tidak hanya  karena pertimbangan ekonomi semata.', '', 'Nilai 4 - \r\n(1)   Alasan penerimaan untuk meningkatkan layanan pendidikan\r\n(2) proses dilakukan secara ketat dan baik\r\n(3)   mahasiswa yang diterima bermutu akademik tinggi', NOW(), NOW(), ".$id."),
('3.2.1', 'Rata-rata masa studi lulusan dan rata-rata IPK\r\nPerhitungan skor untuk masing-masing  program studi S1 yang dikelola Fakultas/ Sekolah Tinggi\r\n\r\na.  Rata-rata masa studi (MS)\r\n1:   MS  5.5 tahun\r\n2:  5 ≤ MS < 5.5 tahun\r\n3:  4.5 ≤ MS < 5 tahun\r\n4:  MS < 4.5 tahun\r\n\r\nb.  Rata-rata IPK \r\n2:  2.00 ≤ IPK < 2.75\r\n3:  2.75 ≤ IPK < 3.00\r\n4:  ≥ 3.0\r\n', '', 'Nilai 4 - Jika NSPS ≥ 3.5, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.2.2', 'Upaya pengembangan dan peningkatan mutu lulusan: jenis program yang dilakukan dan efektivitas pelaksanaannya.', '', 'Nilai 4 - \r\n(1)  Ada upaya, dilaksanakan dengan baik \r\n(2)  hasilnya sangat efektif.', NOW(), NOW(), ".$id."),
('4.1.1', 'Kecukupan dan kualifikasi dosen tetap  pada Fakultas/Sekolah Tinggi\r\n\r\nKeterangan:\r\nPerhitungan skor untuk masing-masing program studi S1 yang dikelola, sebagai berikut:\r\n2 : Memenuhi standar pelayanan minimum. \r\n3 : Dosen tetap sesuai dalam jumlah dan kualifikasi, dengan rasio mahasiswa:\r\ndosen kurang dari 17 atau lebih dari 23 untuk PS eksakta;  \r\nkurang dari 26 atau lebih dari 34 untuk PS non-eksakta\r\n4 : Dosen tetap sesuai dalam jumlah dan kualifikasi, dengan rasio mahasiswa:dosen antara 17 s.d. 23 untuk PS eksakta; antara  26 s.d. 34 untuk PS non-eksakta\r\n', '', 'Nilai 4 - Jika NSDT ≥ 3.5, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.1.2.a', 'Upaya pengembangan dan peningkatan mutu dosen tetap\r\n\r\nBeban kerja ideal  dosen tetap berkisar antara  11 s.d. 13 sks', '', 'Nilai 4 - Jumlah  dosen yang pensiun/keluar maupun  dosen baru membuat rata-rata beban kerja dosen ada dalam  kisaran ideal.', NOW(), NOW(), ".$id."),
('4.1.2.b', 'Dosen yang tugas belajar \r\n\r\nPerhitungan skor sebagai berikut:\r\nApabila dosen tetap di Fakultas/Sekolah Tinggi yang berpendidikan (terakhir) S2 dan S3 > 90% atau yang berpendidikan S3 > 40%, maka skor pada butir ini = 4.\r\n\r\nJika tidak, skor butir ini dihitung dengan cara berikut:\r\n\r\nN2 = Jumlah dosen tetap Fakultas/Sekolah Tinggi yang mengikuti tugas belajar jenjang S2/Sp-1 \r\nN3 = Jumlah dosen tetap Fakultas/Sekolah Tinggi yang mengikuti tugas belajar jenjang S3/Sp-2\r\nN = Banyaknya program studi', '', 'Nilai 4 - Jika SD ≥ 4, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.1.3', 'Upaya fakultas dalam mengembangkan tenaga dosen tetap\r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\n\r\nJika  dosen tetap berpendidikan    (terakhir) S2 dan S3 > 90% atau jika dosen tetap yang berpendidikan S3 > 40%, maka skor pada butir ini sama dengan 4.\r\n\r\nJika tidak, maka penentuan skor gunakan kolom di sebelah kanan.', '', 'Nilai 4 - Upaya pengembangan sangat baik, tercermin dari proyeksi yang jelas, terencana dan didukung sepenuhnya oleh institusi (dalam hal pendanaan, maupun beban tugas).', NOW(), NOW(), ".$id."),
('4.2', 'Kecukupan dan kualifikasi tenaga kependidikan', '', 'Nilai 4 - Cukup dalam jumlah untuk melakukan tugasnya dengan sangat baik/efektif, serta memiliki kualifikasi yang memadai.', NOW(), NOW(), ".$id."),
('5.1', 'Bentuk dukungan Fakultas/Sekolah Tinggi dalam penyusunan, implementasi, dan pengembangan kurikulum antara lain dalam bentuk penyediaan fasilitas, pengorganisasian kegiatan, serta bantuan pendanaan.', '', 'Nilai 4 - Fakultas/Sekolah Tinggi sangat berperan dengan memberi fasilitas yang sangat baik, termasuk pendanaan.', NOW(), NOW(), ".$id."),
('5.2', 'Fakultas/Sekolah Tinggi melakukan monitoring dan evaluasi secara bersistem dan hasilnya digunakan untuk perbaikan proses pembelajaran.', '', 'Nilai 4 - Fakultas/Sekolah Tinggi melakukan monitoring dan evaluasi secara bersistem dan terus menerus dan hasilnya digunakan untuk perbaikan proses pembelajaran.', NOW(), NOW(), ".$id."),
('5.3', 'Bentuk dukungan dapat berupa:\r\n\r\n(1) kebijakan tentang suasana akademik jelas, \r\n(2) menyediakan sarana dan prasarana \r\n(3) dukungan dana yang cukup\r\n(4) kegiatan akademik di dalam dan di luar kelas yang mendorong interaksi akademik antara dosen dan mahasiswa untuk pengembangan  perilaku kecendekiawanan.\r\n\r\nSetiap subbutir dinilai dengan gradasi:\r\n4: sangat baik\r\n3: baik\r\n2: cukup\r\n1: kurang\r\n\r\nNBDF = Jumlah nilai subbutir dibagi 4.\r\n', '', 'Nilai 4 - Jika NBDF ≥ 3.5, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.a', 'Penggunaan dana untuk operasional (pendidikan, penelitian, pengabdian pada masyarakat) \r\n\r\nNDOP = Jumlah dana operasional per mahasiswa per tahun.', '', 'Nilai 4 - Jika NDOP ≥ 18 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.b', 'Dana penelitian dalam tiga tahun terakhir.\r\n\r\nNDPD = Rata-rata dana penelitian per dosen tetap per tahun.\r\n', '', 'Nilai 4 - Jika NDPD ≥ 3 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.c', 'Dana yang diperoleh dalam rangka pelayanan/pengabdian kepada masyarakat dalam tiga tahun terakhir.\r\n\r\nNDPKM = Rata-rata dana pelayanan/ pengabdian kepada masyarakat per dosen tetap per tahun.\r\n', '', 'Nilai 4 - Jika NDPKM ≥ 1.5 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.2.a', 'Kecukupan dana yang diperoleh Fakultas/Sekolah Tinggi.', '', 'Nilai 4 - Jumlah dana mencukupi seluruh keperluan operasional dan pengembangan.', NOW(), NOW(), ".$id."),
('6.1.2.b', 'Upaya pengembangan dana.', '', 'Nilai 4 - Upaya dan hasilnya sangat baik.', NOW(), NOW(), ".$id."),
('6.2.1', 'Investasi untuk pengadaan sarana dalam tiga tahun terakhir dibandingkan dengan kebutuhan saat ini ', '', 'Nilai 4 - Sangat memadai, sehingga tidak hanya untuk pengadaan sarana pendukung proses pembelajaran, juga untuk sarana kegiatan ekstra kurikuler.', NOW(), NOW(), ".$id."),
('6.2.2', 'Rencana investasi untuk pengadaan sarana dalam lima tahun ke depan', '', 'Nilai 4 - Rencana investasi untuk sarana sangat realistis, didukung dengan kepastian dana yang memadai.', NOW(), NOW(), ".$id."),
('6.3.1', 'Mutu dan kecukupan akses prasarana yang dikelola Fakultas/Sekolah Tinggi untuk keperluan PS.', '', 'Nilai 4 -  Prasarana sangat lengkap untuk kegiatan Tridarma PT.', NOW(), NOW(), ".$id."),
('6.3.2', 'Rencana pengembangan prasarana oleh Fakultas/Sekolah tinggi untuk program studi', '', 'Nilai 4 - Fakultas/Sekolah Tinggi sangat baik dalam perencanaan pengadaan prasarana, didukung oleh dana yang memadai sehingga  memungkinkan memiliki  prasarana yang  lengkap.', NOW(), NOW(), ".$id."),
('6.4.1.a', 'Sistem informasi dan fasilitas yang digunakan Fakultas/Sekolah Tinggi dalam proses pembelajaran (hardware, software, e-learning, perpustakaan, dll.)', '', 'Nilai 4 - Dengan komputer yang terhubung dengan jaringan luas/internet, software yang berlisensi dengan jumlah yang memadai. Tersedia fasilitas e-learning yang digunakan secara baik, dan akses on-line ke koleksi perpustakaan.', NOW(), NOW(), ".$id."),
('6.4.1.b', 'Sistem informasi dan fasilitas yang digunakan Fakultas dalam administrasi (akademik, keuangan, personil, dll.).', '', 'Nilai 4 - Dengan komputer yang terhubung dengan jaringan luas/internet dengan software basis data yang memadai. Akses terhadap data yang relevan sangat cepat.', NOW(), NOW(), ".$id."),
('6.4.2', 'Aksesibilitas data dalam sistem informasi.', '', 'Nilai 4 - Jika NSIF ≥ 3.5, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.4.3', 'Media/cara penyebaran informasi/kebijakan untuk sivitas akademika di fakultas/sekolah tinggi dapat dilakukan melalui enam jenis media:\r\n1. Surat\r\n2. Faksimili\r\n3. Mailing list, e-mail\r\n4.  SMS  \r\n5. Buletin  \r\n6. Lainnya', '', 'Nilai 4 - Menggunakan secara efektif  fasilitas mailing list  dan  e-mail.', NOW(), NOW(), ".$id."),
('6.4.4', 'Rencana strategis pengembangan sistem informasi jangka panjang: mempertimbangkan perkembangan teknologi informasi, dan komitmen Fakultas/Sekolah Tinggi dalam hal pendanaan.', '', 'Nilai 4 - Ada rencana pengembang-an, sudah memperhitung-kan perkem-bangan teknologi dan kebutuhan akan akses informasi yang cepat didukung dengan pendanaan yang memadai.', NOW(), NOW(), ".$id."),
('7.1.1.a', 'Banyaknya kegiatan penelitian', '', 'Nilai 4 - Jika RP ≥ 1, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.1.1.b', 'Besar dana penelitian (dalam juta rupiah)', '', 'Nilai 4 - Jika RDP ≥ 3 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.1.2', 'Upaya pengembangan kegiatan penelitian oleh pihak Fakultas/ Sekolah Tinggi', '', 'Nilai 4 - Ada upaya dan sangat efektif meningkatkan jumlah penelitian dan dananya.', NOW(), NOW(), ".$id."),
('7.2.1.a', 'Banyak kegiatan PkM ', '', 'Nilai 4 - Jika RPKM ≥ 0.5, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.2.1.b', 'Besar dana PkM', '', 'Nilai 4 - Jika RDPKM ≥ 1.5 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.2.2', 'Upaya pengembangan', '', 'Nilai 4 - Ada upaya dan sangat efektif meningkatkan jumlah kegiatan PkM dan dananya.', NOW(), NOW(), ".$id."),
...
('7.3.2', 'Kegiatan kerjasama dengan instansi di luar negeri dalam tiga tahun terakhir.\r\n\r\n\r\nCatatan;\r\nTingkat kecukupan bergantung pada jumlah dosen tetap  Fakultas/Sekolah Tinggi\r\n', '', 'Nilai 4 - Ada kerjasama dengan institusi di luar negeri, banyak dalam jumlah.  Semuanya  relevan dengan bidang keahlian PS.', NOW(), NOW(), ".$id.")");
        ...
        public function buatbutir3BD3($id){
            $this->db->query("INSERT INTO `butir` (`butir`, `bakumutu`, `penjelasan`, `keterangan`, `created_at`, `updated_at`, `id_borang`) VALUES
('1.1.1', 'Kejelasan,  kerealistikan, dan keterkaitan antar visi, misi, tujuan, dan sasaran program studi.', '', 'Nilai 4 - Memiliki visi, misi, tujuan, dan sasaran yang:\r\n(1)   Sangat jelas\r\n(2) Sangat realistik\r\n(3) Saling terkait satu sama lain', NOW(), NOW(), ".$id."),
('1.1.2', 'Strategi pencapaian sasaran dengan rentang waktu yang jelas dan didukung oleh dokumen.', '', 'Nilai 4 - Strategi pencapaian sasaran:\r\n(1)  dengan tahapan waktu yang jelas dan sangat realistik\r\n(2) didukung dokumen yang sangat lengkap. ', NOW(), NOW(), ".$id."),
('1.2', 'Tingkat pemahaman sivitas akademika  dan tenaga kependidikan terhadap visi, misi, tujuan dan sasaran unit pengelola program studi.', '', 'Nilai 4 - Dipahami dengan baik oleh seluruh sivitas akademika  dan tenaga kependidikan. ', NOW(), NOW(), ".$id."),
('2.1', 'Tata pamong menjamin terwujudnya visi, terlaksananya misi, tercapainya tujuan, berhasilnya strategi yang digunakan secara kredibel, transparan, akuntabel, bertanggung jawab, dan adil.', '', 'Nilai 4 - Adanya dokumen, data dan informasi yang sahih dan andal bahwa seluruh unsur tata pamong menjamin penyelenggaraan perguruan tinggi yang memenuhi 5 pilar berikut: \r\n(1)  kredibel\r\n(2) transparan\r\n(3)   akuntabel\r\n(4)    bertanggung jawab\r\n(5)    adil', NOW(), NOW(), ".$id."),
('2.2', 'Efisiensi dalam struktur organisasi.', '', 'Nilai 4 - Struktur organisasi mampu menggerakkan fungsi lembaga secara sangat efisien.', NOW(), NOW(), ".$id."),
('2.3', 'Kepemimpinan yang efektif (kepemimpinan operasional, kepemimpinan organisasi, dan kepemimpinan publik).', '', 'Nilai 4 - Kepemimpinan unit pengelola program studi diploma kuat dalam semua karakteristik berikut: \r\n(1) kepemimpinan operasional, \r\n(2) kepemimpinan organisasi, \r\n(3) kepemimpinan publik.', NOW(), NOW(), ".$id."),
('2.4', 'Sistem pengelolaan fungsional dan operasional unit pengelola program studi diploma mencakup: Perencanaan, pengorganisasian, pengembangan staf, pengawasan, pengarahan, representasi, dan penganggaran  yang efektif dilaksanakan.\r\n\r\nHal ini dicirikan dengan adanya dokumen:\r\n(4)   Renstra dan Renop Fakultas/ PT\r\n(5)   Rencana pengembangan unit pengelola program studi\r\n(6)    Organisasi yang mendukung\r\n(7)    Sistem pengawasan\r\n(8)    Standard Operating Procedure (SOP)', '', 'Nilai 4 - Sistem pengelolaan fungsional dan operasional unit pengelola program studi diploma berjalan sesuai dengan SOP, yang didukung dokumen yang lengkap.', NOW(), NOW(), ".$id."),
('2.5.1', 'Keberadaan dan efektivitas unit pelaksana penjaminan mutu.', '', 'Nilai 4 - Memiliki unit penjaminan mutu di unit pengelola program studi diploma telah sepenuhnya melakukan proses penjaminan mutu.', NOW(), NOW(), ".$id."),
('2.5.2', 'Ketersediaan dan pelaksanaan standar mutu.', '', 'Nilai 4 - Tersedia standar mutu yang  lengkap dan dilaksanakan dengan sangat baik.', NOW(), NOW(), ".$id."),
('3.1.1', 'Ketersediaan dokumen tentang penerimaan mahasiswa baru dan pelaksanaannya.  \r\n\r\nDokumen sistem penerimaan mahasiswa baru mencakup:\r\n(1)    kebijakan penerimaan mahasiswa baru\r\n(2)  kriteria penerimaan mahasiswa baru \r\n(3)  prosedur penerimaan mahasiswa baru\r\n(4)   instrumen penerimaan mahasiswa baru \r\n(5) sistem pengambilan keputusan', '', 'Nilai 4 - Tersedia dokumen tentang penerimaan mahasiswa baru dan dilaksanakan secara konsisten. ', NOW(), NOW(), ".$id."),
('3.1.2', 'Rasio mahasiswa baru transfer terhadap mahasiswa baru reguler.', '', 'Nilai 4 - Jika RM ≤ 0.25, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.3', 'Tujuan, proses penerimaan, dan mutu mahasiswa transfer.\r\n\r\nAlasan menerima mahasiswa transfer seharusnya untuk meningkatkan layanan pendidikan.  Penerimaan mahasiswa transfer dilakukan dengan proses seleksi yang baik/ketat dalam upaya tetap menjaga mutu, tidak hanya  karena pertimbangan ekonomi semata.', '', 'Nilai 4 - \r\n(1)  Tujuan penerimaan untuk meningkatkan layanan pendidikan\r\n(2) Proses dilakukan secara ketat dan baik sehingga mahasiswa yang diterima bermutu akademik tinggi', NOW(), NOW(), ".$id."),
('3.2.1.1', 'Rata-rata masa studi lulusan\nPenilaian butir ini dihitung dengan cara berikut:\nSkor akhir =  Jumlah skor seluruh PS diploma sejenjang / Banyaknya PS diploma sejenjang\nPerhitungan skor rata-rata masa studi:\n•    Skor untuk PS D4:\n1:   MS ≥ 5.5 tahun\n2:  5 ≤ MS < 5.5 tahun\n3:  4.5 ≤ MS < 5 tahun\n4:  MS < 4.5 tahun\n•   Skor untuk PS D3:\n1:   MS ≥ 4.5 tahun\n2:  4 ≤ MS < 4.5 tahun\n3:  3.5 ≤ MS < 4 tahun\n4:  MS < 3.5 tahun\n•   Skor untuk PS D2:\n1:   MS ≥ 3.5 tahun\n2:  3 ≤ MS < 3.5 tahun\n3:  2.5 ≤ MS < 3 tahun\n4:  MS < 2.5 tahun\n•   Skor untuk PS D1:\n1:   MS ≥ 2.5 tahun\n2:  2 ≤ MS < 2.5 tahun\n3:  1.5 ≤ MS < 2 tahun\n4:  MS < 1.5 tahun', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('3.2.1.2', 'Rata-rata IPK lulusan\nPenilaian butir ini dihitung dengan cara berikut:\nSkor akhir =  Jumlah skor seluruh PS diploma sejenjang / Banyaknya PS diploma sejenjang\n\nPerhitungan skor rata-rata IPK:\n1: 2.00 ≤ IPK ≤ 2.25\n2: 2.25 < IPK ≤ 2.50\n3: 2.50 < IPK ≤ 2.75\n4: IPK > 2.75', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('3.2.2', 'Upaya pengembangan dan peningkatan mutu lulusan: jenis program yang dilakukan dan efektivitas pelaksanaannya.', '', 'Nilai 4 - Ada upaya pengembangan dan peningkatan mutu dengan hasil yang sangat baik.', NOW(), NOW(), ".$id."),
('4.1.1', 'Kecukupan dan kualifikasi dosen tetap  pada unit pengelola program studi diploma. \r\n\r\nSkor butir ini dihitung dengan cara berikut:\r\n\r\nSkor akhir =  Jumlah skor seluruh program studi / Banyaknya program studi\r\nKeterangan:\r\nPerhitungan skor untuk masing-masing program studi yang dikelola, sebagai berikut:\r\n2 : Memenuhi standar pelayanan minimum. \r\n3 : Dosen tetap sesuai dalam jumlah dan kualifikasi, dengan rasio mahasiswa:\r\ndosen kurang dari 17 atau lebih dari 23 untuk PS non-IPS;  \r\nkurang dari 26 atau lebih dari 34 untuk PS IPS\r\n4 : Dosen tetap sesuai dalam jumlah dan kualifikasi, dengan rasio mahasiswa:dosen antara 17 s.d. 23 untuk PS non-IPS; antara  26 s.d. 34 untuk PS IPS', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('4.1.2', 'Dosen yang tugas belajar ', '', 'Nilai 4 - Jika SD ≥ 4, maka skor = 4.', NOW(), NOW(), ".$id."),
...
('4.2', 'Kecukupan, kompetensi, dan kualifikasi tenaga kependidikan.', '', 'Nilai 4 - Cukup dalam jumlah untuk melakukan tugasnya dengan sangat baik/efektif, serta memiliki kualifikasi yang memadai.', NOW(), NOW(), ".$id."),
('5.1', 'Bentuk dukungan unit pengelola program studi diploma dalam penyusunan, implementasi, dan pengembangan kurikulum antara lain dalam bentuk penyediaan fasilitas, pengorganisasian kegiatan, serta bantuan pendanaan.', '', 'Nilai 4 - Unit pengelola program studi diploma sangat berperan dengan memberi fasilitas yang sangat baik, termasuk pendanaan.', NOW(), NOW(), ".$id."),
('5.2', 'Unit pengelola program studi diploma melakukan monitoring dan evaluasi secara bersistem dan hasilnya digunakan untuk perbaikan proses pembelajaran.', '', 'Nilai 4 - Unit pengelola program studi diploma melakukan monitoring dan evaluasi secara bersistem dan terus menerus dan hasilnya digunakan untuk perbaikan proses pembelajaran.', NOW(), NOW(), ".$id."),
('5.3', 'Dukungan unit pengelola program studi diploma dalam penciptaan  suasana akademik.\r\n\r\nDukungan dapat berupa:\r\n\r\n(1) kejelasan kebijakan tentang suasana akademik, \r\n(2) penyediaan sarana dan prasarana \r\n(3) dukungan dana yang cukup\r\n(4) kegiatan akademik di dalam dan di luar kelas yang mendorong interaksi akademik antara dosen dan mahasiswa untuk pengembangan  perilaku kecendekiawanan.\r\n\r\nSetiap subbutir dinilai dengan gradasi:\r\n4: sangat baik\r\n3: baik\r\n2: cukup\r\n1: kurang\r\n\r\nSkor akhir = Jumlah nilai subbutir dibagi 4.', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('6.1.1.1', 'Persentase perolehan dana dari mahasiswa dibandingkan dengan total penerimaan dana (= PDMHS)', '', 'Nilai 4 - Jika PDMHS ≤ 30%, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.2', 'Biaya satuan pendidikan per mahasiswa per tahun.\r\n\r\nBSP =  Biaya satuan pendidikan per mahasiswa per tahun.', '', 'Nilai 4 - Jika BSP  ≥ 15 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.3', 'Dana penelitian dalam tiga tahun terakhir.\r\n\r\nRata-rata dana penelitian/dosen tetap/tahun (=RPD)', '', 'Nilai 4 - Jika RPD ≥ Rp 2 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.1.4', 'Dana yang diperoleh dalam rangka pelayanan/pengabdian kepada masyarakat dalam tiga  tahun terakhir.\r\n\r\nRata-rata dana pengabdian/dosen tetap/tahun (=RPKM)', '', 'Nilai 4 - Jika RPKM ≥ Rp 4 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.1.2.1', 'Kecukupan dana yang diperoleh unit pengelola program studi diploma.\r\n\r\nKet: Dana operasional dikatakan cukup jika dana yang diperoleh lebih dari Rp 15 juta/mahasiswa.', '', 'Nilai 4 - Jumlah dana mencukupi seluruh keperluan operasional dan pengembangan.', NOW(), NOW(), ".$id."),
('6.1.2.2', 'Upaya pengembangan dana.\r\n\r\nJika skor pada butir 6.1.2.1 = 4, maka skor pada butir ini = 4.  \r\n\r\nJika tidak, gunakan aturan di sebelah kanan.', '', 'Nilai 4 - Upaya dan hasilnya sangat baik.', NOW(), NOW(), ".$id."),
('6.2.1', 'Investasi untuk pengadaan sarana dalam tiga tahun terakhir dibandingkan dengan kebutuhan saat ini. ', '', 'Nilai 4 - Sangat memadai, sehingga tidak hanya untuk pengadaan sarana pendukung proses pembelajaran, juga untuk sarana kegiatan ekstra kurikuler.', NOW(), NOW(), ".$id."),
('6.2.2', 'Rencana investasi untuk pengadaan sarana dalam lima tahun ke depan.\r\n\r\nCatatan: \r\nJika sarana dinilai sangat lengkap, maka skor butir ini sama dengan empat.', '', 'Nilai 4 - Rencana investasi untuk sarana sangat realistis, didukung dengan kepastian dana yang memadai.', NOW(), NOW(), ".$id."),
('6.3.1', 'Mutu dan kecukupan akses prasarana yang dikelola unit pengelola program studi diploma untuk keperluan PS.\r\n\r\nKelengkapan prasarana mencakup prasarana akademik (pendukung kegiatan tridarma) dan non-akademik (fasilitas pengembangan minat, bakat dan kesejahteraan).', '', 'Nilai 4 - Prasarana sangat lengkap, dibuktikan dengan tersedianya  fasilitas pendukung kegiatan akademik dan non-akademik yang sangat memadai.', NOW(), NOW(), ".$id."),
('6.3.2', 'Rencana pengembangan prasarana oleh unit pengelola program studi diploma.\r\n\r\nJika prasarana dikelola di tingkat perguruan tinggi, maka informasi tentang prasarana mesti digali pada tingkat tersebut.', '', 'Nilai 4 - Unit pengelola program studi diploma sangat baik dalam perencanaan pengadaan prasarana, didukung oleh dana yang memadai sehingga  memungkinkan memiliki  prasarana yang  lengkap.\r\n\r\nAtau jika prasarana saat ini dinilai sangat baik (skor butir 6.3.1 sama dengan 4).', NOW(), NOW(), ".$id."),
('6.4.1.1', 'Pemanfaatan teknologi komunikasi dan informasi  untuk proses pembelajaran, termasuk e-learning.', '', 'Proses pembelajaran telah memanfaatkan TI dan ada fasilitas e-learning dan dimanfaatkan dengan baik.', NOW(), NOW(), ".$id."),
('6.4.1.2', 'Pemanfaatan teknologi komunikasi dan informasi  untuk penyelenggaraan administrasi (misalkan SIAKAD, SIMKEU, SIMAWA, SIMFA, SIMPEG). ', '', 'Nilai 4 - Semua jenis SIM tersedia dan dimanfaatkan dengan baik.', NOW(), NOW(), ".$id."),
('6.4.1.3', 'Pemanfaatan teknologi komunikasi dan informasi  untuk proses pengambilan keputusan dalam pengembangan institusi (antara lain informasi berupa deskripsi, ringkasan, dan trend berbagai jenis data).', '', 'Nilai 4 - Sistem informasi sangat menunjang proses pengambilan keputusan.', NOW(), NOW(), ".$id."),
('6.4.2', 'Aksesibilitas data dalam sistem informasi dan komunikasi.\r\n\r\nNilai butir ini didasarkan pada hasil penilaian 12 jenis data (lihat kolom 1 pada tabel butir 6.4.2) dengan cara berikut:\r\nSkor akhir =  Jumlah keseluruhan skor dari 12 jenis data / 12\r\n\r\nSedang  Untuk setiap jenis data, penilaian didasarkan atas aturan berikut:\r\n1: Data ditangani secara manual \r\n2: Data ditangani dengan komputer tanpa jaringan\r\n3: Data ditangani dengan komputer, serta dapat diakses melalui  jaringan lokal (Local Area Network, LAN)\r\n4: Data ditangani dengan komputer, serta dapat diakses melalui jaringan luas (Wide  Area Network, WAN)', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('6.4.3', 'Media/cara penyebaran informasi/kebijakan untuk sivitas akademika dan tenaga kependidikan di unit pengelola program studi diploma dapat dilakukan melalui enam jenis media:\r\n1.    Rapat/pertemuan\r\n2.   Surat\r\n3. Faksimili/telepon/SMS\r\n4. e-mail\r\n5.    Mailing list\r\n6.  Buletin  \r\n7. Lainnya', '', 'Nilai 4 - Menggunakan semua jenis media informasi sesuai dengan sifat informasinya dan secara efektif.', NOW(), NOW(), ".$id."),
('6.4.4', 'Rencana strategis pengembangan sistem informasi jangka panjang: mempertimbangkan perkembangan teknologi informasi, dan komitmen unit pengelola program studi diploma dalam hal pendanaan.', '', 'Nilai 4 - Ada rencana pengembang-an, sudah memperhitung-kan perkem-bangan teknologi dan kebutuhan akan akses informasi yang cepat didukung dengan pendanaan yang memadai.', NOW(), NOW(), ".$id."),
('7.1.1.1', 'Banyaknya kegiatan penelitian dosen tetap program studi diploma sejenjang. \r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\n\r\nSkor akhir =  Jumlah skor seluruh program studi diploma sejenjang / Banyaknya program studi diploma sejenjang.\r\n\r\nSedangkan penghitungan skor untuk masing-masing  program studi diploma sejenjang yang dikelola unit pengelola program studi diploma adalah sebagai berikut:\r\nRJP =  rata-rata jumlah penelitian per dosen tetap per tiga tahun\r\n0:  Tidak ada penelitian.\r\n1:  0 < RJP < 0.2\r\n2:  0.2 ≤ RJP < 0.6\r\n3:  0.6 ≤ RJP < 1.0\r\n4:  RJP ≥  1.0', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('7.1.1.2', 'Besar dana penelitian dosen tetap program studi diploma sejenjang.\n\nPenilaian butir ini dihitung dengan cara berikut:\n\nSkor akhir =  Jumlah skor seluruh program studi diploma sejenjang / Banyaknya program studi diploma sejenjang.\n \nSedangkan penghitungan skor untuk masing-masing  program studi diploma yang dikelola unit pengelola program studi diploma adalah sebagai berikut:\n0:  Tidak ada dana penelitian.\n1:  Ada dana penelitian, namun rata-rata dana penelitian < Rp 0.5 juta per dosen tetap per tahun.\n2:  Rata-rata dana penelitian lebih atau sama dengan  Rp 0.5 juta tapi kurang dari  Rp 1 juta per dosen tetap per tahun.\n3:  Rata-rata dana penelitian lebih atau sama dengan Rp 1 juta tapi kurang dari Rp 2 juta per dosen tetap per tahun\n4:  Rata-rata dana penelitian lebih atau sama dengan Rp 2 juta per dosen tetap per tahun.', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('7.1.2', 'Upaya pengembangan kegiatan penelitian oleh unit pengelola program studi diploma.', '', 'Nilai 4 - Ada upaya dan sangat efektif meningkatkan jumlah penelitian dan dananya.', NOW(), NOW(), ".$id."),
('7.2.1.1', 'Banyak kegiatan PkM dosen tetap seluruh program studi diploma sejenjang.\r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\n\r\nSkor akhir =  Jumlah skor seluruh PS diploma sejenjang / Banyaknya PS diploma sejenjang\r\n\r\nSedangkan penghitungan skor untuk masing-masing  program studi diploma yang dikelola unit pengelola program studi diploma adalah sebagai berikut:\r\nRPkM =  rata-rata banyaknya kegiatan PkM per dosen per 3 tahun.\r\n\r\n0:  Tidak ada kegiatan PkM\r\n1:  0 < RPkM < 0.5\r\n2:  0.5 ≤ RPkM < 1.0\r\n3:  1.0 ≤ RPkM < 2.0\r\n4:  RPkM ≥  2', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('7.2.1.2', 'Besar dana PkM dosen tetap seluruh program studi diploma sejenjang.\r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\n\r\nSkor akhir =  Jumlah skor seluruh PS diploma sejenjang / Banyaknya PS diploma sejenjang\r\n\r\nSedangkan penghitungan skor untuk masing-masing  program studi diploma yang dikelola unit pengelola program studi diploma adalah sebagai berikut:\r\n\r\n0:  Tidak ada dana PkM\r\n1:  Ada dana PkM, namun rata-rata dana PkM < Rp 1 juta per dosen tetap per tahun.\r\n2:  Rata-rata dana PkM lebih lebih atau sama dengan Rp 1 juta tapi kurang dari  Rp 2.5 juta per dosen tetap per tahun.\r\n3:  Rata-rata dana PkM lebih atau sama dengan Rp 2.5  juta tapi kurang dari Rp 4 juta per dosen tetap per tahun. \r\n4:  Rata-rata dana PkM lebih atau sama dengan Rp 4 juta per dosen tetap per tahun.', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('7.2.2', 'Upaya pengembangan kegiatan PkM oleh unit pengelola program studi diploma.', '', 'Nilai 4 - Ada upaya dan sangat efektif meningkatkan jumlah kegiatan PkM dan dananya.', NOW(), NOW(), ".$id."),
('7.3.1', 'Kegiatan kerjasama dengan instansi di dalam negeri dalam tiga tahun terakhir\r\n\r\nCatatan;\r\nTingkat kecukupan bergantung pada jumlah dosen tetap unit pengelola program studi diploma', '', 'Nilai 4 - Ada kerjasama dengan institusi di dalam negeri, banyak dalam jumlah.  Semuanya  relevan dengan bidang keahlian PS.', NOW(), NOW(), ".$id."),
('7.3.2', 'Kegiatan kerjasama dengan instansi di luar negeri dalam tiga tahun terakhir.\r\n\r\nCatatan;\r\nTingkat kecukupan bergantung pada jumlah dosen tetap  unit pengelola program studi diploma', '', 'Nilai 4 - Ada kerjasama dengan institusi di luar negeri, banyak dalam jumlah.  Semuanya  relevan dengan bidang keahlian PS.', NOW(), NOW(), ".$id.")");
    ...
    $data = array(
        ...
        public function buatbutir3AD3($id){
            $this->db->query("INSERT INTO `butir` (`butir`, `bakumutu`, `penjelasan`, `keterangan`, `created_at`, `updated_at`, `id_borang`) VALUES
('1.1.1', 'Kejelasan,  kerealistikan, dan keterkaitan antar visi, misi, tujuan,  sasaran program studi, dan pemangku kepentingan yang terlibat.', '', 'Nilai 4 - Memiliki visi, misi, tujuan, dan sasaran yang:\r\n(1)  Sangat jelas.\r\n(2)    Sangat realistik.\r\n(3)    Saling terkait satu sama lain.\r\n(4)   Melibatkan dosen, mahasiswa, tenaga kependidikan, alumni dan masyarakat.', NOW(), NOW(), ".$id."),
('1.1.2', 'Strategi pencapaian sasaran dengan rentang waktu yang jelas dan didukung oleh dokumen.', '', 'Nilai 4 - Strategi pencapaian sasaran:\r\n(1)  dengan tahapan waktu yang jelas dan sangat realistik.\r\n(2) didukung dokumen yang sangat lengkap.', NOW(), NOW(), ".$id."),
('1.2', 'Pemahaman pemangku kepentingan internal (sivitas akademika dan tenaga kependidikan) terhadap visi, misi, tujuan dan sasaran program studi.', '', 'Nilai 4 - Dipahami dengan baik oleh seluruh sivitas akademika  dan tenaga kependidikan.', NOW(), NOW(), ".$id."),
('2.1', 'Jaminan tata pamong untuk mewujudkan visi, melaksanakan misi, mencapai tujuan dengan menggunakan strategi secara kredibel, transparan, akuntabel, bertanggung jawab dan adil.', '', 'Nilai 4 - Adanya dokumen, data dan informasi yang sahih dan andal bahwa seluruh unsur tata pamong menjamin penyelenggaraan program studi yang memenuhi lima pilar berikut: \r\n(1)    kredibel\r\n(2) transparan\r\n(3)   akuntabel\r\n(4)    bertanggung jawab\r\n(5)    adil', NOW(), NOW(), ".$id."),
('2.2', 'Karakteristik kepemimpinan di program studi yang mencakup: kepemimpinan operasional, kepemimpinan organisasi, dan kepemimpinan publik.', '', 'Nilai 4 - Kepemimpinan program studi memiliki karakteristik yang kuat dalam: \r\n(1) kepemimpinan operasional, \r\n(2) kepemimpinan organisasi, \r\n(3) kepemimpinan publik.', NOW(), NOW(), ".$id."),
('2.3', 'Sistem pengelolaan fungsional dan operasional program studi mencakup: \r\n(1)  perencanaan, \r\n(2)    pengorganisasian, \r\n(3)   pengembangan staf, \r\n(4)  pengawasan, \r\n(5) pengarahan, \r\n(6) representasi, dan \r\n(7)   penganggaran \r\nyang dilaksanakan secara efektif.\r\n\r\nHal ini dicirikan dengan adanya dokumen:\r\n(1)   Renstra dan renop fakultas/ PT\r\n(2)   Rencana pengembangan program studi\r\n(3)   Standard Operating Procedure (SOP)', '', 'Nilai 4 - Sistem pengelolaan fungsional dan operasional program studi dilakukan sesuai dengan SOP, yang didukung dokumen yang lengkap.', NOW(), NOW(), ".$id."),
('2.4', 'Pelaksanaan penjaminan mutu di program studi, mencakup: \r\n(1)  Kesesuaian dengan kebijakan penjaminan mutu unit pengelola, \r\n(2)  Sistem dokumentasi, dan \r\n(3)  Tindak lanjut terhadap laporan pelaksanaan', '', 'Nilai 4 - (1) Ada kebijakan evaluasi dan pengendalian mutu program yang efektif. Sistem telaah program sangat baik (ada cara validasi yang handal). Pelaksanaan di PS sangat sesuai dengan kebijakan tersebut.\r\n(2) Ada sistem dokumentasi yang bermutu sangat baik.\r\n(3) Semua laporan ditindaklanjuti.', NOW(), NOW(), ".$id."),
('2.5', 'Umpan balik  untuk peningkatan mutu proses pembelajaran.  Informasi mencakup: sumber umpan balik, keberlanjutan pelaksanaan, dan tindak lanjutnya.\r\n\r\nCatatan:\r\n(1)  Sumber umpan balik antara lain dari: dosen, mahasiswa, alumni, pengguna lulusan.m\r\n(2)    Pelaksanaan secara berkala (minimum sekali dalam 3 tahun)\r\n(3)    Tindak lanjut untuk perbaikan kurikulum, pelaksanaan proses pembelajaran, dan peningkatan kegiatan program studi.', '', 'Nilai 4 - Umpan balik:\r\n(1)  Diperoleh dari empat sumber\r\n(2)  Dilakukan secara berkala \r\n(3)    Ditindaklanjuti ', NOW(), NOW(), ".$id."),
('2.6', 'Upaya-upaya yang telah dilakukan penyelenggara program studi untuk menjamin keberlanjutan (sustainability) program studi.\r\n\r\nUpaya yang dilakukan mencakup:\r\n(1) Upaya untuk peningkatan animo calon mahasiswa\r\n(2)    Upaya peningkatan mutu manajemen\r\n(3) Upaya untuk peningkatan mutu lulusan\r\n(4) Upaya untuk pelaksanaan dan hasil kerjasama kemitraan\r\n(5)    Upaya dan prestasi memperoleh dana dari sumber selain dari mahasiswa.', '', 'Nilai 4 - Ada bukti semua usaha dilakukan dengan hasil yang  baik.', NOW(), NOW(), ".$id."),
('3.1.1.1', 'Rasio calon mahasiswa yang ikut seleksi : daya tampung.', '', 'Nilai 4 - Jika rasio ≥ 4, \r\nmaka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.1.2', 'Rasio mahasiswa baru reguler yang melakukan registrasi : calon mahasiswa baru reguler yang lulus seleksi.', '', 'Nilai 4 - Jika rasio ≥ 90%,\r\nmaka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.1.3', 'Rasio mahasiswa baru transfer terhadap mahasiswa baru regular.', '', 'Nilai 4 - Jika RM ≤ 0.25, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.2', 'Penghargaan atas prestasi mahasiswa di bidang nalar, bakat dan minat.', '', 'Nilai 4 - Ada bukti penghargaan juara lomba ilmiah, olah raga, maupun seni tingkat internasional, nasional, wilayah, dan lokal PT.', NOW(), NOW(), ".$id."),
('3.1.1.4', 'Rata-rata Indeks Prestasi Kumulatif (IPK) selama lima tahun terakhir.', '', 'Nilai 4 - Jika IPK ≥ 3, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.3.1', 'Persentase kelulusan tepat waktu (KTW).', '', 'Nilai 4 - Untuk Diploma IV = Jika KTW ≥ 50%, maka skor = 4. Untuk Diploma III = Jika KTW ≥ 60%, maka skor = 4. Untuk Diploma II = Jika KTW ≥ 70%, maka skor = 4. Untuk Diploma I = Jika KTW ≥ 80%, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.1.3.2', 'Persentase mahasiswa yang DO atau mengundurkan diri (MDO).', '', 'Nilai 4 - Jika MDO ≤  6%, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.2.1', 'Jenis layanan yang disediakan kepada mahasiswa yang dapat dimanfaatkan untuk membina dan mengembangkan penalaran, minat, bakat, seni, dan kesejahteraan. \r\n\r\nJenis pelayanan kepada mahasiswa antara lain:\r\n1. Bimbingan dan konseling\r\n2.   Minat dan bakat (ekstra kurikuler)\r\n3.    Pembinaan soft skill\r\n4.  Layanan beasiswa\r\n5.  Layanan kesehatan', '', 'Nilai 4 - Ada semua (lima jenis) pelayanan mahasiswa yang dapat diakses.', NOW(), NOW(), ".$id."),
('3.2.2', 'Mutu layanan yang disediakan kepada mahasiswa yang dapat dimanfaatkan untuk membina dan mengembangkan penalaran, minat, bakat, seni, dan kesejahteraan. \r\n\r\nUntuk setiap jenis pelayanan, pemberian skor sebagai berikut:\r\n4 : sangat baik\r\n3 : baik\r\n2 : cukup\r\n1 : kurang\r\n0 : sangat kurang', '', 'Nilai 4 - Skor = SL. SL = Jumlah skor untuk semua layanan / 5', NOW(), NOW(), ".$id."),
('3.3', 'Usaha-usaha program studi/jurusan mencarikan tempat kerja bagi lulusannya', '', 'Nilai 4 - Kelima jenis upaya dilakukan dengan baik.', NOW(), NOW(), ".$id."),
('3.4.1.1', 'Upaya pelacakan dan perekaman data lulusan.', '', 'Nilai 4 - Ada upaya yang intensif untuk melacak  lulusan dan datanya terekam secara komprehensif.', NOW(), NOW(), ".$id."),
('3.4.1.2', 'Penggunaan hasil pelacakan untuk perbaikan aspek berikut: \r\n(1) proses pembelajaran, \r\n(2) penggalangan dana, \r\n(3) informasi pekerjaan, \r\n(4) membangun jejaring.', '', 'Nilai 4 - Hasil pelacakan untuk perbaikan  empat aspek.', NOW(), NOW(), ".$id."),
('3.4.1.3', 'Pendapat pengguna (employer) lulusan terhadap mutu alumni.\r\n\r\nAda tujuh jenis kemampuan.\r\nSkor akhir = [4 x (a) + 3 x (b) + 2 x (c) + (d)]/7', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('3.4.2', 'Keahlian/kemampuan yang menunjukkan keunggulan lulusan program studi.', '', 'Nilai 4 - Keahlian lulusan sangat relevan dengan kebutuhan lapangan kerja, memiliki keunggulan yang menjadi nilai tambah dalam persaingan kerja.', NOW(), NOW(), ".$id."),
('3.4.3', 'Masa tunggu lulusan untuk memperoleh pekerjaan yang pertama.\r\n\r\nRMT = rata-rata masa tunggu lulusan memperoleh pekerjaan yang pertama.', '', 'Nilai 4 - Jika RMT ≤ 6 bulan, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.4.4', 'Kesesuaian bidang kerja lulusan dengan bidang studi.\r\n\r\nPBS = persentase kesesuaian bidang kerja dengan bidang studi (keahlian) lulusan', '', 'Jika PBS ≥ 80%, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.4.5', 'Lulusan yang dipesan dan diterima oleh lembaga (instansi/industri)\r\n\r\nPLP = Persentase  lulusan yang dipesan dan diterima oleh lembaga (instansi/industri)', '', 'Nilai 4 - Jika PLP ≥ 10%, maka skor = 4.', NOW(), NOW(), ".$id."),
('3.5', 'Partisipasi alumni dalam mendukung pengembangan  program studi.\r\n\r\nBentuk partisipasi antara lain: \r\n(1) Sumbangan dana\r\n(2)   Sumbangan fasilitas\r\n(3)  Masukan untuk perbaikan proses pembelajaran\r\n(4)  Pengembangan jejaring', '', 'Nilai 4 - Semua bentuk partisipasi dilakukan oleh alumni.', NOW(), NOW(), ".$id."),
('4.1', 'Pedoman tertulis tentang rekrutmen, penempatan, pengembangan, retensi, dan pemberhentian dosen dan tenaga kependidikan, serta efektivitas pelaksanaannya. ', '', 'Nilai 4 - Ada pedoman tertulis yang lengkap; dan ada bukti dilaksanakan secara efektif.', NOW(), NOW(), ".$id."),
('4.2.1', 'Pedoman tertulis tentang sistem monitoring dan evaluasi, serta rekam jejak kinerja dosen dan tenaga kependidikan, dan konsistensi pelaksanaannya.', '', 'Nilai 4 - Ada pedoman tertulis yang lengkap; dan ada bukti dilaksanakan secara konsisten', NOW(), NOW(), ".$id."),
('4.2.2', 'Pelaksanaan monitoring dan evaluasi kinerja dosen di bidang  pendidikan, penelitian, pelayanan/pengabdian kepada masyarakat.', '', 'Nilai 4 - Ada bukti tentang kinerja dosen di bidang  \r\n(1) pendidikan\r\n(2) penelitian \r\n(3) pelayanan/ pengabdian kepada masyarakat \r\nyang terdokumentasi dengan baik.', NOW(), NOW(), ".$id."),
('4.3.1.1', 'Dosen tetap berpendidikan minimal S2 yang bidang keahliannya sesuai dengan kompetensi PS. \r\n\r\nKD1 = Persentase dosen tetap berpendidikan minimal S2 yang bidang keahliannya sesuai dengan kompetensi PS.', '', 'Nilai 4 - Jika KD1 ≥ 90%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.3.1.2', 'Dosen tetap yang memiliki jabatan lektor kepala yang bidang keahliannya sesuai dengan kompetensi PS. \r\nKD2 = Persentase Dosen tetap yang memiliki jabatan lektor kepala yang bidang keahliannya sesuai dengan kompetensi PS.', '', 'Nilai 4 - Jika KD2 ≥ 40%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.3.1.3', 'Rasio mahasiswa terhadap dosen tetap yang bidang keahliannya sesuai dengan bidang PS (RMD).\r\n\r\nCatatan: \r\n- Jumlah mahasiswa reguler diambil dari tabel 3.1.1.\r\n- Jumlah dosen tetap diambil dari tabel 4.3.1.', '', 'Nilai 4 - Untuk IPS = Rasio mahasiswa terhadap dosen tetap yang bidang keahliannya sesuai dengan bidang PS (RMD).\r\nCatatan: \r\n- Jumlah mahasiswa reguler diambil dari tabel 3.1.1.\r\n- Jumlah dosen tetap diambil dari tabel 4.3.1.\r\nUntuk non-IPS = Jika 17 ≤ RMD ≤ 23, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.3.2.1', 'Dosen tetap yang memiliki Sertifikat Pendidik Profesional.\r\n\r\nKD3 = Persentase dosen tetap yang memiliki Sertifikat Pendidik Profesional.', '', 'Nilai 4 - Jika KD3 ≥ 40%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.3.2.2', 'Dosen tetap yang memiliki Sertifikat Kompetensi/Profesi.\r\n\r\nKD4 = Persentase dosen tetap yang memiliki Sertifikat Kompetensi/Profesi.', '', 'Nilai 4 - Jika KD4 ≥ 80%.', NOW(), NOW(), ".$id."),
('4.3.3', 'Rata-rata beban kerja dosen per semester dalam SKS (=RFTE).', '', 'Nilai 4 - Jika 11 ≤ RFTE ≤  13 sks, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.3.4 & 4.3.5', 'Kesesuaian keahlian (pendidikan terakhir) dosen dengan mata kuliah yang diajarkannya.', '', 'Nilai 4 - Semua mata kuliah diajar oleh dosen yang sesuai keahliannya.', NOW(), NOW(), ".$id."),
('4.3.4 & 4.3.5', 'Persentase kehadiran dosen tetap dalam perkuliahan.\r\nPKDT = Persentase kehadiran dosen tetap dalam perkuliahan (terhadap jumlah kehadiran yang direncanakan).', '', 'Nilai 4 - Jika PKDT ≥ 95%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.4.1', 'Persentase jumlah dosen tidak tetap, terhadap jumlah seluruh dosen (= PDTT).', '', 'Nilai 4 - Jika PDTT ≤ 10%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.4.2.1', 'Kesesuaian keahlian dosen tidak tetap dengan mata kuliah yang diajarkan.', '', 'Nilai 4 - Semua dosen tidak tetap mengampu mata kuliah yang sesuai keahliannya', NOW(), NOW(), ".$id."),
('4.4.2.2', 'Persentase kehadiran dosen tidak tetap dalam perkuliahan \r\n\r\nPKDTT = Persentase kehadiran dosen tidak tetap dalam perkuliahan (terhadap jumlah kehadiran yang direncanakan).', '', 'Nilai 4 - Jika PKDTT ≥ 95%, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.5.1', 'Kegiatan tenaga ahli/pakar sebagai pembicara dalam seminar/pelatihan, pembicara tamu, dsb, dari luar PT sendiri (tidak termasuk dosen tidak tetap).\r\n\r\nCatatan: Tenaga ahli dari luar perguruan tinggi dengan tujuan untuk pengayaan pengetahuan dan bukan untuk mengisi kekurangan tenaga pengajar, tidak bekerja secara rutin.', '', 'Nilai 4 - Jika JTAP ≥ 12 orang, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.5.2', 'Peningkatan kemampuan dosen tetap melalui program tugas belajar dalam bidang yang sesuai dengan bidang PS.', '', 'Nilai 4 - Jika SD ≥ 4, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.5.3', 'Kegiatan dosen tetap yang bidang keahliannya sesuai dengan PS dalam seminar ilmiah/ lokakarya/ penataran/ workshop/ pagelaran/ pameran/peragaan yang tidak hanya melibatkan dosen PT sendiri dalam kurun waktu tiga tahun terakhir.', '', 'Nilai 4 - Jika SP ≥ 3, maka skor = 4.', NOW(), NOW(), ".$id."),
('4.5.4', 'Prestasi dosen dalam mendapatkan penghargaan hibah, pendanaan program dan kegiatan akademik dari tingkat internasional, nasional, wilayah, dan lokal dalam tiga tahun terakhir.', '', 'Nilai 4 - Mendapatkan penghargaan hibah, pendanaan program dan kegiatan akademik dari institusi tingkat internasional (disertai bukti).', NOW(), NOW(), ".$id."),
('4.5.5', 'Reputasi dan keluasan jejaring dosen dalam bidang akademik dan profesi.', '', 'Nilai 4 - Jika PMBI ≥ 50%, maka skor = 4.', NOW(), NOW(), ".$id."),
...
('4.6.2', 'Upaya yang telah dilakukan PS dalam meningkatkan kualifikasi dan kompetensi tenaga kependidikan. \r\n\r\nUpaya peningkatan kualifikasi dan kompetensi dikaitkan dengan:\r\n1.    Pemberian kesempatan belajar/pelatihan\r\n2.    Pemberian fasilitas, termasuk dana\r\n3.    Jenjang karir', '', 'Nilai 4 - Upaya pengembangan telah dilakukan dengan sangat baik sehingga dapat meningkatkan kualifikasi dan kompetensi tenaga kependidikan.', NOW(), NOW(), ".$id."),
('5.1.1.1', 'Kelengkapan dan perumusan kompetensi.', '', 'Nilai 4 - Kurikulum memuat kompetensi lulusan secara lengkap (utama, pendukung, lainnya) yang terumuskan secara sangat jelas.', NOW(), NOW(), ".$id."),
('5.1.1.2', 'Orientasi dan kesesuaian dengan visi dan misi.', '', 'Nilai 4 - Sesuai dengan visi-misi, sudah berorientasi  ke masa depan.', NOW(), NOW(), ".$id."),
('5.1.2.1.1', 'Kesesuaian mata kuliah dan urutannya dengan standar kompetensi. \r\n\r\nCatatan:\r\nUntuk menilai kesesuaian mata kuliah dan urutannya, bila perlu asesor memperhatikan silabus/materi  mata kuliah', '', 'Nilai 4 - Sesuai dengan standar kompetensi, sudah berorientasi  ke masa depan.', NOW(), NOW(), ".$id."),
('5.1.2.1.2', 'Jumlah SKS yang digunakan untuk kegiatan praktikum/ praktek/ PKL (=JSKS )\r\nCatatan: \r\nHarus dipastikan bahwa 1 SKS praktek/praktikum minimum 2 jam kegiatan terjadwal per minggu dan 1 SKS praktek kerja lapangan = 4 jam kegiatan per minggu.  Jika  1 SKS untuk praktek/praktikum jumlahnya kurang dari 2 jam, harus disesuaikan dengan beban SKS baku.\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nContoh:\r\nProgram studi A, informasinya jumlah SKS untuk praktikum = 10 SKS, sedangkan 1 SKS = 3 jam praktikum. SKS untuk praktikum ini dinilai sama dengan 10 SKS.\r\n\r\nProgram studi Z, informasinya jumlah SKS untuk praktikum = 10 SKS, sedangkan 1 SKS = 1 jam praktikum. SKS untuk praktikum ini dinilai sama dengan 5 SKS.', '', 'Nilai 4 - Program Studi Diploma IV, Bidang IPS =\r\nJika Jsks ≥ 42, maka skor = 4.\r\nProgram Studi Diploma III, Bidang IPS =\r\nJika Jsks ≥ 37, maka skor = 4.\r\nProgram Studi Diploma II, Bidang IPS =\r\nJika Jsks ≥ 32, maka skor = 4.\r\nProgram Studi Diploma I, Bidang IPS =\r\nJika Jsks ≥ 18, maka skor = 4.\r\nProgram Studi Diploma IV, Bidang Non-IPS =\r\nJika Jsks ≥ 57, maka skor = 4.\r\nProgram Studi Diploma III, Bidang Non-IPS =\r\nJika Jsks ≥ 52, maka skor = 4.\r\nProgram Studi Diploma II, Bidang Non-IPS =\r\nJika Jsks ≥ 42, maka skor = 4.\r\nProgram Studi Diploma I, Bidang Non-IPS =\r\nJika Jsks ≥ 23, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.1.2.1.3', 'Persentase mata kuliah  yang dalam penentuan nilai akhirnya memberikan bobot pada tugas-tugas (PR atau laporan) ≥ 20% → PTGS\n\nCara penghitungan:\nJumlah mata kuliah  yang diberi tanda √ pada kolom (7) dibagi dengan jumlah total mata kuliah wajib dan pilihan.', '', 'Nilai 4 - Jika PTGS ≥ 60%, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.1.2.1.4', 'Persentase mata kuliah dilengkapi dengan deskripsi mata kuliah, silabus dan SAP (= MKSAP)', '', 'Nilai 4 - Jika MKSAP ≥ 95%, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.1.2.2', 'Substansi dan pelaksanaan praktikum/praktek.\r\n\r\nCatatan:\r\nPeer group diharapkan menentukan modul-modul praktikum/praktek yang harus dilakukan, syarat minimal maupun yang lebih baik.', '', 'Nilai 4 - Pelaksanaan modul praktikum/praktek lebih dari cukup  (ditambah dengan demonstrasi di laboratorium ) di PT sendiri.', NOW(), NOW(), ".$id."),
('5.2.1', 'Mekanisme monitoring perkuliahan. \r\n\r\nPelaksanaan pembelajaran memiliki mekanisme untuk memonitor, mengkaji, dan memperbaiki setiap semester tentang:\r\n(a) kehadiran mahasiswa\r\n(b) kehadiran dosen\r\n(c) materi kuliah\r\n\r\nPenilaian butir ini dihitung dengan cara berikut:\r\nSkor akhir  =  Jumlah skor tiap butir / 3\r\nSedangkan penghitungan skor untuk setiap butir  sebagai berikut:\r\n1: Tidak ada monitoring\r\n2: Ada monitoring tetapi tidak ada evaluasi\r\n3: Ada monitoring, evaluasi tidak kontinu\r\n4: Ada monitoring  dan evaluasi secara kontinu', '', 'Nilai 4 - Skor = Skor akhir.', NOW(), NOW(), ".$id."),
('5.2.2', 'Jumlah jam real yang digunakan untuk kegiatan praktikum/ praktek/ PKL (=Jjam real )', '', 'Nilai 4 - Program Studi Diploma IV, Bidang IPS\r\nJika Jjam real ≥ 1880, maka skor = 4.\r\nProgram Studi Diploma III, Bidang IPS\r\nJika Jjam real ≥ 1642, maka skor = 4.\r\nProgram Studi Diploma II, Bidang IPS\r\nJika Jjam real ≥ 1376, maka skor = 4.\r\nProgram Studi Diploma I, Bidang IPS\r\nJika Jjam real ≥ 832, maka skor = 4.\r\n\r\nProgram Studi Diploma IV, Bidang Non-IPS\r\nJika Jjam real ≥ 2390, maka skor = 4.\r\nProgram Studi Diploma III, Bidang Non-IPS\r\nJika Jjam real ≥ 2084, maka skor = 4.\r\nProgram Studi Diploma II, Bidang Non-IPS\r\nJika Jjam real ≥ 1716, maka skor = 4.\r\nProgram Studi Diploma I, Bidang Non-IPS\r\nJika Jjam real ≥ 934, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.2.3', 'Mutu soal ujian\r\n\r\nPSoal = persentase paket naskah ujian yang mutunya baik dan sesuai dengan silabus mata kuliah.', '', 'Nilai 4 - Jika PSoal  ≥  90%, maka skor = 4.',NOW(), NOW(), ".$id."),
('5.3.1', 'Peninjauan kurikulum selama 5 tahun terakhir: mekanisme, pihak yang terlibat, hasil peninjauan.', '', 'Nilai 4 - Pengembangan dilakukan secara mandiri dengan melibatkan pemangku kepentingan internal dan eksternal dan memperhatikan visi, misi, dan umpan balik.', NOW(), NOW(), ".$id."),
('5.3.2', 'Penyesuaian kurikulum dengan perkembangan ipteks dan kebutuhan pemangku kepentingan', '', 'Nilai 4 - Pembaharuan kurikulum dilakukan sesuai dengan perkembangan ilmu di bidangnya dan kebutuhan pemangku kepentingan.', NOW(), NOW(), ".$id."),
('5.4.1.1', 'Rata-rata banyaknya mahasiswa per dosen Pembimbing Akademik (PA)/Wali per semester (=RMPA)', '', 'Nilai 4 - Jika RMPA ≤ 20, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.4.1.2', 'Jumlah rata-rata pertemuan pembimbingan per mahasiswa per semester (= PP)\r\n\r\nCatatan:\r\nPenilaian didasarkan pada rata-rata data  pada kolom 4 dari Tabel 5.4.1.', '', 'Nilai 4 - Jika PP ≥ 3.0 maka skor = 4.', NOW(), NOW(), ".$id."),
('5.4.2.1', 'Pelaksanaan kegiatan pembimbingan akademik: keterlibatan dosen dan kesesuaian pelaksanaannya dengan panduan.\r\n\r\nCatatan:\r\nPenilaian didasarkan pada jawaban nomor 1, 2 pada kolom 1 dari Tabel 5.4.2.', '', 'Nilai 4 - Dilakukan oleh seluruh dosen PA dengan baik sesuai panduan tertulis.', NOW(), NOW(), ".$id."),
('5.4.2.2', 'Efektivitas kegiatan perwalian.\r\n\r\nCatatan:\r\nPenilaian didasarkan pada jawaban nomor 3,4,5 pada kolom 1 dari Tabel 5.4.2.', '', 'Nilai 4 - Sistem bantuan dan bimbingan akademik sangat efektif.', NOW(), NOW(), ".$id."),
('5.5.1', 'Bentuk dan mutu karya/tugas akhir.', '', 'Nilai 4 - Untuk program studi diploma yang tidak mensyaratkan karya/tugas akhir\r\n(Penilaian didasarkan atas mata kuliah (MK) yang menjadi penciri kompetensi utama) = \r\nMK penciri kompetensi utama lulusan  sangat relevan dengan kebutuhan lapangan kerja, berorientasi ke masa depan.\r\n\r\nUntuk program studi diploma yang mensyaratkan karya/tugas akhir = \r\nMutu sangat relevan dengan kebutuhan lapangan kerja, berorientasi ke masa depan.', NOW(), NOW(), ".$id."),
('5.5.2.1', 'Ketersediaan panduan, sosialisasi, dan pelaksanaan karya/tugas akhir.', '', 'Nilai 4 - Ada panduan tertulis yang disosialisasikan dan dilaksanakan dengan konsisten.', NOW(), NOW(), ".$id."),
('5.5.2.2', 'Rata-rata mahasiswa per dosen pembimbing karya/tugas akhir (TA). ', '', 'Nilai 4 - Jika 0 < RMTA ≤ 4, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.5.2.3', 'Rata-rata jumlah pertemuan/pembimbingan selama penyelesaian karya/tugas akhir (=RBTA)', '', 'Nilai 4 - Jika RBTA ≥ 8, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.5.2.4', 'Kualifikasi akademik dosen pembimbing tugas akhir.\r\n\r\nPDTA = Persentase dosen pembimbing tugas akhir yang memiliki sertifikat kompetensi/profesi.', '', 'Nilai 4 - Jika PDTA ≥ 90%, maka skor = 4.', NOW(), NOW(), ".$id."),
('5.6', 'Upaya perbaikan sistem pembelajaran yang telah dilakukan selama tiga tahun terakhir berkaitan dengan: \r\na.   Materi\r\nb.    Metode pembelajaran\r\nc.   Penggunaan teknologi pembelajaran\r\nd. Cara-cara evaluasi', '', 'Nilai 4 - Upaya perbaikan dilakukan untuk  semua dari yang seharusnya diperbaiki/ ditingkatkan.', NOW(), NOW(), ".$id."),
('5.7.1', 'Kebijakan tentang suasana akademik (otonomi keilmuan, kebebasan akademik, kebebasan mimbar akademik).', '', 'Nilai 4 - Tersedia dokumen tentang kebijakan suasana akademik yang lengkap mencakup otonomi keilmuan, kebebasan akademik, kebebasan mimbar akademik.', NOW(), NOW(), ".$id."),
('5.7.2', 'Ketersediaan dan jenis prasarana, sarana dan dana yang memungkinkan terciptanya interaksi akademik antara sivitas akademika.', '', 'Nilai 4 - Tersedia, milik sendiri,  sangat lengkap dan dana yang sangat memadai.', NOW(), NOW(), ".$id."),
('5.7.3', 'Program dan kegiatan akademik untuk menciptakan suasana akademik (seminar, simposium, lokakarya, bedah buku, penelitian bersama dll).', '', 'Nilai 4 - Upaya baik dan hasilnya suasana kondusif untuk meningkatkan suasana akademik.', NOW(), NOW(), ".$id."),
('5.7.4', 'Interaksi akademik antara dosen-mahasiswa', '', 'Nilai 4 - Upaya baik dan hasilnya suasana kondusif untuk meningkatkan suasana akademik yang baik.', NOW(), NOW(), ".$id."),
('5.8', 'Pembekalan lulusan program studi dengan etika profesi.', '', 'Nilai 4 - Ada dan cara pembekalannya sangat baik, diberikan dalam mata kuliah khusus.', NOW(), NOW(), ".$id."),
('5.9', 'Budaya keselamatan kerja dalam kegiatan praktikum/praktek: \r\n•   ketersediaan pedoman, \r\n• keefektifan pelaksanaannya, dan\r\n•    kelengkapan peralatan dan bahan.', '', 'Nilai 4 -\r\n•  Pedoman sangat lengkap. \r\n•   Pelaksanaan pedoman sangat efektif.\r\n•    Peralatan/bahan keselamatan kerja sangat lengkap.', NOW(), NOW(), ".$id."),
('6.1', 'Keterlibatan program studi dalam perencanaan target kinerja, perencanaan kegiatan/ kerja dan perencanaan alokasi dan pengelolaan dana.', '', 'Nilai 4 - Program studi secara otonom melaksanakan perencanaan alokasi  dan pengelolaan dana.', NOW(), NOW(), ".$id."),
('6.2.1.1', 'Persentase perolehan dana dari mahasiswa dibandingkan dengan total penerimaan dana (= PDMHS)', '', 'Nilai 4 - Jika PDMHS ≤ 30%, maka skor =4.', NOW(), NOW(), ".$id."),
('6.2.1.2', 'Dana operasional  per mahasiswa per tahun.\r\n\r\nDOM = Jumlah dana operasional/mahasiswa/tahun (juta rupiah)', '', 'Nilai 4 - Program Studi Diploma Bidang IPS\r\nJika DOM ≥ 15, maka skor = 4.\r\nProgram Studi Diploma Bidang Non-IPS\r\nJika DOM ≥ Rp 20 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.2.2', 'Dana penelitian dosen dalam tiga tahun terakhir.\r\n\r\nRata-rata dana penelitian/dosen tetap/tahun (=RPD)', '', 'Nilai 4 - Jika RPD ≥ Rp 2 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.2.3', 'Dana  pelayanan/ pengabdian kepada masyarakat dalam tiga  tahun terakhir.\r\n\r\nRata-rata dana pengbdian/dosen tetap/tahun (=RPKM)', '', 'Nilai 4 - Jika RPKM ≥ Rp 4 juta, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.3.1', 'Ruang kerja dosen\r\n\r\nCatatan: Data diambil dari kolom 3, tabel 6.3.1.\r\nJika luas ruang rata-rata untuk dosen tetap (= jumlah luas ruang dosen tetap dibagi dengan jumlah dosen tetap) kurang dari 4 m2, maka skor pada subbutir ini = nol.  ', '', 'Nilai 4 - Skor = SLRDT', NOW(), NOW(), ".$id."),
('6.3.2', 'Kelengkapan, kepemilikan, dan mutu prasarana (kantor, ruang kelas, ruang laboratorium, studio, ruang perpustakaan, kebun percobaan, dsb. kecuali  ruang dosen) yang dipergunakan PS dalam proses pembelajaran.', '', 'Nilai 4 - Prasarana lengkap dan mutunya sangat baik untuk proses pembelajaran, dan milik sendiri.', NOW(), NOW(), ".$id."),
('6.3.3', 'Kelayakan prasarana lain yang menunjang (misalnya tempat olah raga, ruang bersama, ruang himpunan mahasiswa, poliklinik)', '', 'Nilai 4 - Prasarana penunjang lengkap dan mutunya sangat baik untuk memenuhi kebutuhan mahasiswa.', NOW(), NOW(), ".$id."),
('6.4.1.1', 'Bahan pustaka yang relevan, berupa buku teks.', '', 'Nilai 4 - \r\nProgram Studi Diploma IV\r\nJika jumlah judul ≥216, maka skor = 4.\r\nProgram Studi Diploma III\r\nJika jumlah judul ≥165, maka skor = 4.\r\nProgram Studi Diploma II\r\nJika jumlah judul ≥120, maka skor = 4.\r\nProgram Studi Diploma I\r\nJika jumlah judul ≥60, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.4.1.3', 'Bahan pustaka berupa majalah ilmiah populer', '', 'Nilai 4 - ≥ 2 judul jurnal yang relevan dan nomornya lengkap.', NOW(), NOW(), ".$id."),
('6.4.1.2', 'Bahan pustaka berupa modul praktikum/praktek\r\n\r\nPModul= Persentase modul untuk praktikum/ praktek', '', 'Nilai 4 - Jika 60% < PModul ≤ 100%, maka skor = (10 x PModul) – 6.', NOW(), NOW(), ".$id."),
('6.4.1.4', 'Bahan pustaka berupa jurnal ilmiah terakreditasi Dikti', '', 'Nilai 4 - ≥ 2 judul jurnal yang relevan dan nomornya lengkap.', NOW(), NOW(), ".$id."),
('6.4.1.5', 'Bahan pustaka  berupa jurnal ilmiah internasional.', '', 'Nilai 4 - ≥ 2 judul jurnal, nomornya lengkap', NOW(), NOW(), ".$id."),
('6.4.1.6', 'Bahan pustaka berupa prosiding seminar dalam tiga tahun terakhir', '', 'Nilai 4 - Jika jumlah prosiding seminar ≥ 6, maka skor = 4.', NOW(), NOW(), ".$id."),
('6.4.2', 'Akses ke perpustakaan di luar PT atau sumber pustaka lainnya.', '', 'Nilai 4 - Ada perpustakaan di luar PT yang dapat diakses dan sangat baik fasilitasnya \r\n\r\nAtau jika nilai rata-rata dari butir 6.4.1 ≥ 3.', NOW(), NOW(), ".$id."),
('6.4.3', 'Ketersediaan, akses dan pendayagunaan sarana utama di lab (tempat praktikum, bengkel, studio, ruang simulasi, rumah sakit, puskesmas/balai kesehatan, green house, lahan untuk pertanian, dan sejenisnya)', '', 'Nilai 4 - Sangat memadai, terawat dengan sangat baik, dan PS memiliki akses yang sangat baik (memiliki fleksibilitas dalam menggunakannya di luar kegiatan praktikum terjadwal).', NOW(), NOW(), ".$id."),
('6.5.1', 'Sistem informasi dan fasilitas yang digunakan PS dalam proses pembelajaran (hardware, software, e-learning, akses on-line ke perpustakaan, dll.)', '', 'Nilai 4 - Proses pembelajaran menggunaan komputer yang terhubung dengan jaringan luas/internet. Software yang digunakan di laboratorium berlisensi/open source dengan jumlah yang memadai. Tersedia fasilitas e-learning yang digunakan secara baik, dan akses on-line ke koleksi perpustakaan.', NOW(), NOW(), ".$id."),
('6.5.2', 'Aksesibilitas data dalam sistem informasi\r\n\r\nNilai butir ini didasarkan pada hasil penilaian 11 jenis data (lihat kolom 1 pada tabel butir 6.5.2) dengan cara berikut:\r\nSkor akhir = \r\n(jumlah total skor pada ke-11 jenis data) : 11\r\n\r\nSedang  untuk setiap jenis data, penilaian didasarkan atas aturan berikut:\r\nskor =1: Data ditangani secara manual \r\nskor =2: Data ditangani dengan komputer tanpa jaringan\r\nskor =3: Data ditangani dengan komputer, serta dapat diakses melalui  jaringan lokal (LAN)\r\nskor =4: Data ditangani dengan komputer, serta dapat diakses melalui jaringan luas (WAN)', '', 'Nilai 4 - Skor = Skor akhir', NOW(), NOW(), ".$id."),
('7.1.1', 'Jumlah penelitian yang sesuai dengan bidang keilmuan PS, yang dilakukan oleh dosen tetap yang bidang keahliannya sama dengan PS selama 3 tahun.', '', 'Nilai 4 - Jika NK ≥ 1, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.1.2', 'Jumlah artikel ilmiah yang dihasilkan oleh dosen tetap yang bidang keahliannya sama dengan PS selama 3 tahun', '', 'Nilai 4 - Jika NK ≥ 3, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.1.3', 'Karya-karya PS/institusi yang telah memperoleh perlindungan Hak atas Kekayaan Intelektual (Paten/HaKI) atau karya yang mendapat pengakuan/penghargaan dari lembaga nasional/internasional.', '', 'Nilai 4 - Dua atau lebih karya yang memperoleh Paten/HaKI atau karya yang mendapat pengakuan/penghargaan dari lembaga nasional/internasional.', NOW(), NOW(), ".$id."),
('7.2.1', 'Jumlah kegiatan pelayanan/pengabdian kepada masyarakat (PkM) yang dilakukan oleh dosen tetap yang bidang keahliannya sama dengan PS selama tiga tahun.', '', 'Nilai 4 - Jika NK ≥ 2, maka skor = 4.', NOW(), NOW(), ".$id."),
('7.2.2', 'Keterlibatan mahasiswa dalam kegiatan pelayanan/pengabdian kepada masyarakat', '', 'Nilai 4 - Mahasiswa terlibat penuh dan diberi tanggung jawab.', NOW(), NOW(), ".$id."),
('7.3.1', 'Kegiatan kerjasama dengan instansi di dalam negeri dalam tiga tahun terakhir\r\n\r\nCatatan;\r\nTingkat kecukupan proporsional dengan jumlah dosen tetap PS.', '', 'Nilai 4 - Ada kerjasama dengan institusi di dalam negeri, banyak dalam jumlah.  Semuanya  relevan dengan bidang keahlian PS.', NOW(), NOW(), ".$id."),
('7.3.2', 'Kegiatan kerjasama dengan instansi di luar negeri dalam tiga tahun terakhir.\r\n\r\nCatatan;\r\nTingkat kecukupan proporsional dengan jumlah dosen tetap PS', '', 'Nilai 4 - Ada lebih dari satu kerjasama dengan institusi di luar negeri yang relevan dengan bidang PS.', NOW(), NOW(), ".$id.")");
